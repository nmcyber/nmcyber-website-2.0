  ...
  return (
    ...
    <div className="min-w-0 w-full h-full"> 
      <div className="flex items-baseline gap-1">
        <span className="text-white font-semibold text-[22px] sm:text-[26px] leading-none">NM</span>
        <span className="text-accent font-semibold text-[22px] sm:text-[26px] leading-none">CYBER</span>
      </div>
